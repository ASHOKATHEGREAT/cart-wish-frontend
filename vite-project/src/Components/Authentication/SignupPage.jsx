...
const schema = z.object({
    ...
    deliveryAddress: z.string().min(15, {message: "Please enter a delivery address"})
}).refine(data => data.password === data.confirmPassword, {message: "Confirm Password doesn't match with the password provided",
        ...
        <section className='align_center form_page'>
            <form className='authentication_form signup_form' onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='image_input_section'>
                    ...
                    <input type='file' onChange={e => setProfilePic(e.traget.files[0])} id='file-ip-1' className='image_input' />
                </div>
